...
Complete_Graph::Complete_Graph(const int swidth, const int sheight, int dim, float radius, int seed, int numNodes, bool ngon) : swidth{swidth}, sheight{sheight}, dim{dim}, radius{radius}, seed{seed}, numNodes{numNodes}, ngon{ngon}
{
